...
USER_NAME="pi"
SCRIPT_PATH="/home/pi/staf-rasp/script.py"
SERVICE_PATH="/home/pi/staf-rasp/service.py"
WORKING_DIR="/home/pi/staf-rasp"
...
(crontab -l 2>/dev/null; echo "0 * * * * /usr/bin/python3 /home/pi/staf-rasp/service.py") | crontab -
...
SEND_ALL_CSVS_SCRIPT="/home/pi/staf-rasp/send_all_csvs.py"
SEND_CSV_SCRIPT="/home/pi/staf-rasp/send_csv.py"

# Verificar se o arquivo data_backup.csv existe e movê-lo para o diretório de backup
if [ -f "/home/pi/staf-rasp/data_backup.csv" ]; then
    mv /home/pi/staf-rasp/data_backup.csv /home/pi/staf-rasp/backup/
